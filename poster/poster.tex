...
%
\usepackage[orientation=portrait,width=48",height=36",debug]{beamerposter}
...
\author{Reid McIlroy-Young} % Author(s)

\institute{MACSS} % Institution(s)
...
\begin{document}
	...
	\begin{columns}[t] % The whole poster consists of three major columns, the second of which is split into two columns twice - the [t] option aligns each column's content to the top
		...
		\begin{column}{\onecolwid} % The third column
			...
			\begin{center}
				\begin{tabular}{ccc}
					\includegraphics[width=0.4\linewidth]{comparisonAbstract.pdf} & \hfill & \includegraphics[width=0.4\linewidth]{comparisonTitle.pdf}
				\end{tabular}
			\end{center}
